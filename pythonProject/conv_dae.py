...
class ConvAutoencoder(Model):
    def __init__(self):
        ...
        self.encoder = tf.keras.Sequential([layers.Input(shape=(1280,1,1)),
                                            layers.Dense(16,(3,3), activation='relu',padding='same',strides=2),
                                            layers.Dense(8,(3,3), activation='relu',padding='same',strides=2)])
